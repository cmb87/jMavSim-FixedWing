...
public class Simulator implements Runnable {
    ...
    public static final String VEHICLE_MODEL_MC = "models/x8.obj"; //"models/3dr_arducopter_quad_x.obj";
...
//  private int simDelayMax = 500;  // Max delay between simulated and real time to skip samples in simulator, in ms
    ...
    public Simulator() throws IOException, InterruptedException {
        ...
        if (SHOW_GUI) {
            // Create GUI
            System.out.println("Starting GUI with my mods ;)...");  // this is the longest part of startup so let user know
    ...
    private AbstractMulticopter buildMulticopter() {
        ...
        AbstractMulticopter vehicle = new Hexacopter(world, vehicle_model, "x",
                                                     0.33 / 2, 4.0, 0.05, 0.005, gc, SHOW_GUI);
